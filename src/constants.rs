pub const NORMAL_MODE_MOVEMENT: &[(&str, &[&str], &str, &[&str])] = &[
    ...
    (
        "normal-mode/movement/shift-w.gif",
        &["W"],
        "Move next WORD start",
        &[],
    ),
    (
        "normal-mode/movement/shift-b.gif",
        &["B"],
        "Move previous WORD start",
        &[],
    ),
    (
        "normal-mode/movement/shift-e.gif",
        &["E"],
        "Move next WORD end",
        &[],
    ),
    ...
    (
        "normal-mode/movement/shift-t-l.gif",
        &["T", "l"],
        "Find 'till previous 'l'",
        &[],
    ),
    (
        "normal-mode/movement/shift-f-l.gif",
        &["F", "l"],
        "Find previous 'l'",
        &[],
    ),
    (
        "normal-mode/movement/13-shift-g.gif",
        &["1", "3", "G"],
...
pub const NORMAL_MODE_CHANGES: &[(&str, &[&str], &str, &[&str])] = &[
    ...
    (
        "normal-mode/changes/shift-r.gif",
        &["R"],
    ...
    (
        "normal-mode/changes/alt-backtick.gif",
        &["`"],
    ...
    (
        "normal-mode/changes/shift-i.gif",
        &["I"],
        "Insert at the start of the line",
        &[],
    ),
    (
        "normal-mode/changes/shift-a.gif",
        &["A"],
    ...
    (
        "normal-mode/changes/shift-o.gif",
        &["O"],
    ...
    ("normal-mode/changes/shift-u.gif", &["U"], "Redo change", &[]),
    ...
    (
        "normal-mode/changes/shift-p.gif",
        &["P"],
...
pub const NORMAL_MODE_SELECT: &[(&str, &[&str], &str, &[&str])] = &[
    ...
    (
        "normal-mode/select/shift-s.gif",
        &["S", "g", "u", "e", "s", "s"],
    ...
    (
        "normal-mode/select/shift-c.gif",
        &["C"],
        "Copy selection onto the next line (Add cursor below)",
        &[],
    ),
    // (
    //     "normal-mode/select/alt-shift-c.gif",
    //     &["C"],
    ...
    // (
    //     "normal-mode/select/shift-x.gif",
    //     &["X"],
    ...
    // ),
    (
        "normal-mode/select/shift-j.gif",
        &["J"],
        "Join lines inside selection",
        &[],
    ),
    // (
    //     "normal-mode/select/alt-shift-j.gif",
    //     &["J"],
    //     "Join lines inside selection and select the inserted space",
    //     &["Alt"],
    // ),
    // (
    //     "normal-mode/select/shift-k.gif",
    //     &["K"],
    //     "Keep selections matching the regex",
    //     &[],
    // ),
    // (
    //     "normal-mode/select/alt-shift-k.gif",
    //     &["K"],
...
pub const NORMAL_MODE_SEARCH: &[(&str, &[&str], &str, &[&str])] = &[
    ...
    (
        "normal-mode/search/shift-n.gif",
        &["N"],
...
pub const NORMAL_MODE_WINDOW_MODE: &[(&str, &[&str], &str, &[&str])] = &[
    ...
    (
        "normal-mode/minor-modes/window-mode/shift-f.gif",
        &["F"],
    ...
    (
        "normal-mode/minor-modes/window-mode/shift-h.gif",
        &["H"],
        "Swap window to the left",
        &["Control", "w"],
    ),
    (
        "normal-mode/minor-modes/window-mode/shift-j.gif",
        &["J"],
        "Swap window downwards",
        &["Control", "w"],
    ),
    (
        "normal-mode/minor-modes/window-mode/shift-k.gif",
        &["K"],
        "Swap window upwards",
        &["Control", "w"],
    ),
    (
        "normal-mode/minor-modes/window-mode/shift-l.gif",
        &["L"],
